...
use JSDataTables\Filter\AjaxFilter;
use JSDataTables\Entity\AjaxParams;
use JSDataTables\Entity\ConfigDt;
use JSDataTables\Doctrine\ORM\Query\Expr\Select;
use JSDataTables\Doctrine\ORM\Query\Expr\OrderBy;
...
class JSDataTables {
    ...
    /**
     * @var \JSDataTables\Entity\ConfigDt
     */
    protected $dtConfig;
    ...
    public function getInputFilter() {
        if (!$this->inputFilter)
            $this->inputFilter = new AjaxFilter();
